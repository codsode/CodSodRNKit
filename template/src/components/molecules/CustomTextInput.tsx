...
import type { ImageStyle, TextInputProps } from "react-native";
...
const CustomTextInput: React.FC<CustomTextInputProps> = ({
  ...
  return (
    <>
      ...
      >
        {leftImage ? (
          <ImageContainer resizeMode="contain" style={leftImageStyle} source={leftImage} />
        ) : null}
        <TextInput
        ...
        {rightImage ? (
          <Pressable onPress={onPressRight}>
            <ImageContainer source={rightImage} style={rightImageStyle} />
          </Pressable>
        ) : null}
      </View>
    </>
